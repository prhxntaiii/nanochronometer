/* =============================================================================
 * main_x64.c  -  NanoChrono GUI x64  (Win32, static backend)
 *
 * Typography:
...
if (user32) {
    SetProcessDpiAwarenessContextFn set_dpi = (SetProcessDpiAwarenessContextFn)GetProcAddress(user32, "SetProcessDpiAwarenessContext");
    if (set_dpi) {
