/* =============================================================================
 * main_arm64.c  -  NanoChrono GUI ARM64  (Win32, static backend)
 *
 * Typography:
...
#endif
typedef BOOL (WINAPI *NC_SetProcessDpiAwarenessContextFn)(DPI_AWARENESS_CONTEXT);
static void nc_gui_enable_dpi_awareness_arm64(void) {
    HMODULE user32_mod = GetModuleHandleW(L"user32.dll");
    if (!user32_mod) return;
    NC_SetProcessDpiAwarenessContextFn fn = (NC_SetProcessDpiAwarenessContextFn)(void*)GetProcAddress(user32_mod, "SetProcessDpiAwarenessContext");
...
#if defined(_M_ARM64) || defined(__aarch64__)
    nc_gui_enable_dpi_awareness_arm64();
#else
