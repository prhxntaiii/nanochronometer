...
if not defined BUILD_DIR set BUILD_DIR=build_msvc_ninja_x64
...
set NC_TARGET_ARCH=x64
set NC_CMAKE_PROCESSOR=x86_64

call :detect_host_arch
set NC_IS_CROSS=0
if /I not "%NC_HOST_ARCH%"=="%NC_TARGET_ARCH%" set NC_IS_CROSS=1
if /I "%NC_HOST_ARCH%"=="arm64" (
  set NC_VCVARS_ARG=arm64_amd64
) else (
  set NC_VCVARS_ARG=amd64
)
